...
export const SIZE_PRESETS: SizePreset[] = [
  ...
  { id: "amazon-main-image", label: "Amazon main image", width: 2000, height: 2000, description: "Amazon product main image" },
  { id: "amazon-portrait-image", label: "Amazon portrait image", width: 1600, height: 2000, description: "Amazon product portrait image" },
  ...
  { id: "amazon-a-plus", label: "Amazon A+", width: 2928, height: 1200, description: "Amazon A+ content module image" },
