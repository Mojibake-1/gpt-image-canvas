...
const zhMessages = {
  ...
  storageDisabledShort: "云关闭",
  storageDisabledTitle: "云存储未开启",
  storageEnabledCopy: "开启后新图会同时保存到本地和云端；关闭后只保存到本地，不删除已上传文件。",
  storageEnabledLabel: "启用云存储双写",
  storageEnabledShort: "云已开",
  ...
  storageSubtitle: "腾讯云 COS 或 Cloudflare R2，生成图本地保存后同步上传。",
  storageTest: "测试",
...
const enMessages: I18nMessages = {
  ...
  storageDisabledShort: "Cloud off",
  storageDisabledTitle: "Cloud storage disabled",
  storageEnabledCopy: "When on, new images are saved locally and to cloud storage. When off, new images stay local only and uploaded files are not deleted.",
  storageEnabledLabel: "Enable cloud dual write",
  storageEnabledShort: "Cloud on",
  ...
  storageSubtitle: "Tencent Cloud COS or Cloudflare R2 syncs generated images after local save.",
  storageTest: "Test",
  storageTestFailed: "Cloud storage test failed.",
