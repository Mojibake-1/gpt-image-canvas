...
const sizePresetLabels: Record<Locale, Record<string, string>> = {
  "zh-CN": {
    "square-1k": "方形成图 1K",
    "amazon-main-image": "亚马逊主图",
    "amazon-portrait-image": "亚马逊竖图",
  ...
  en: {
    "square-1k": "Square 1K",
    "amazon-main-image": "Amazon main image",
    "amazon-portrait-image": "Amazon portrait image",
...
const zhMessages = {
  ...
  commonSentenceEnd: "。",
  autoSize: "自动",
  autoSizeHint: "将请求 image2 使用自动尺寸，宽高由模型根据提示词决定。",
  autoSizeModel: "模型选择",
  customSize: "自定义",
...
const enMessages: I18nMessages = {
  ...
  commonSentenceEnd: ".",
  autoSize: "Auto",
  autoSizeHint: "Requests automatic sizing so image2 can choose dimensions from the prompt.",
  autoSizeModel: "Model choice",
  customSize: "Custom",
